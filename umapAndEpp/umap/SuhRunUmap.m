    ...
    methods 
        function this=SuhRunUmap(nArgOut, varargin)
            ...
            function [fig, ax,tb,btnClusterRoi,cbSyncKld, comboClu, ...
                ...
                drawnow;
                tb=[]; btnClusterRoi=[]; cbSyncKld=[]; comboClu=[]; lblClu=[]; btnNameRoi=[];
                ...
                if args.roi_table==1 || args.roi_table==3
                    ...
                    ToolBarMethods.addButton(tb, 'polygonGate.png', ...
                        ['Create region of interest with cluster pick'], ...
                        @(h,e)createRoi(h, RoiUtil.POLYGON));
                    
                    btnClusterRoi=ToolBarMethods.addButton(tb, ...
                        'pickGate.png', tip, ...
                        @(h,e)createRoiWithClusterPick());
            ...
            function roiMenu(hObj)
                ...
                Gui.NewMenuItem(jMenu, 'Save current region of interest',...
            ...
            function createRoiWithClusterPick
                if isempty(dbm)
