...
classdef Gui
    ...
    methods (Static)
        function Hs=XGrid(ax, grids, drawLines, theZero, majorTick)
            lim2=get(ax, 'xlim');
            lim=get(ax, 'ylim');
            gray=[.55,.8,.55];
            N=length(grids);
            ...
            for i=1:N
                if grids(i) >= lim2(1) && grids(i) <= lim2(2)
                    ...
                    Hs(end+1)=line([grids(i) grids(i)],...
                        [minTickLim, lim(1)], 'LineWidth', majorTick, ...
        ...
        function Hs=YGrid(ax, grids, drawLines, theZero, majorTick)
            lim2=get(ax, 'ylim');
            lim=get(ax, 'xlim');
            gray=[.55,.8,.55];
            N=length(grids);
            ...
            for i=1:N
                if grids(i) >= lim2(1) && grids(i) <= lim2(2)
                    ...
                    Hs(end+1)=line([minTickLim, lim(1)], ...
                        [grids(i) grids(i)],...
                         'LineWidth', majorTick, ...
                        'clipping', 'off', 'color', 'k', 'Parent', ax);
                end
