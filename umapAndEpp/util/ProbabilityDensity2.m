...
%   License: BSD 3 clause
    ...
    methods
        ...
        function drawColors(this, ax, numberOfJetColors, subsetOfData, ...
            ...
            %CM: Rewrote below section on 2022/03/15. This new method
            %accumulates data points into two matrices where each column is
            %monochromatic, then makes a single call to "line", instead of
            %128 looped calls to "plot". The new method is about twice as
            %fast.
