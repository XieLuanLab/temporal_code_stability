...
classdef QfHiDM < handle
    ...
    methods
        ...
        function [data, unmatched,matchesStr, hasConcordance]...
            ...
            hasConcordance=nMatches>0 && ...
                isfield(this.matches{1}, 'concordance');
                ...
                for j=1:nn
                    ...
                    if ~isempty(idx)
                        ...
                        if hasConcordance
                            ...
                            data{row, 12}=match.robustConcordance;
                        end
                    end
                end
            end 
    ...
    methods(Access=private)
        ...
        function collectBestMatches(this, M, toCellStrings)
            ...
            function cnt=makeMatch(best)
                ...
                if this.areEqual
                    match.concordance=MatBasics.Concordance(...
                        this.tCompData, this.sCompData, this.tIdPerRow, ...
                        tIds_, this.sIdPerRow, sIds_, this.areEqual);
